...
class Translation(object):
	...
	def string(self, id, utf8 = True, system = False):
		if isinstance(id, (int, long)):
			...
			else: result = xbmcaddon.Addon(System.bcrebornAddon).getLocalizedString(id)
		else:
			try: result = str(id)
			except: result = id
		if utf8:
...
class Format(object):
	...
	ColorPoor = 'FFBA4A00'
	ColorBad = 'FF922B21'
	Colorbcreborn1 = 'FFA0C12C'
	Colorbcreborn2 = 'FF3C7DBF'
	ColorWhite = 'FFFFFFFF'
	ColorBlack = 'FF000000'
...
class Settings(object):
	...
	PathDefault = 'Default'
	Paths = {
		'downloads.manual.path.combined' 		: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/',
		'downloads.manual.path.movies'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/Movies/',
		'downloads.manual.path.shows'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/Shows/',
		'downloads.manual.path.documentaries'	: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/Documentaries/',
		'downloads.manual.path.shorts'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/Shorts/',
		'downloads.manual.path.other'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Manual/Other/',

		'downloads.cache.path.combined'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/',
		'downloads.cache.path.movies'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/Movies/',
		'downloads.cache.path.shows'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/Shows/',
		'downloads.cache.path.documentaries'	: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/Documentaries/',
		'downloads.cache.path.shorts'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/Shorts/',
		'downloads.cache.path.other'			: 'special://userdata/addon_data/plugin.video.bcreborn/Downloads/Cache/Other/',

		'library.locations.combined'			: 'special://userdata/addon_data/plugin.video.bcreborn/Library/',
		'library.locations.movies'				: 'special://userdata/addon_data/plugin.video.bcreborn/Library/Movies/',
		'library.locations.shows'				: 'special://userdata/addon_data/plugin.video.bcreborn/Library/Shows/',
		'library.locations.documentaries'		: 'special://userdata/addon_data/plugin.video.bcreborn/Library/Documentaries/',
		'library.locations.shorts'				: 'special://userdata/addon_data/plugin.video.bcreborn/Library/Shorts/',
	}
	...
	def cacheClear(self):
		...
		global SettingsAddon
		SettingsAddon = xbmcaddon.Addon(System.bcrebornAddon)
...
class System(object):
	...
	bcrebornAddon = 'plugin.video.bcreborn'
