...
class PinLoginWindow(kodigui.BaseWindow):
    ...
    def setPin(self, pin):
        self.setProperty('pin.image.0', 'script.plexodus/sign_in/digits/{0}.png'.format(pin[0].upper()))
        self.setProperty('pin.image.1', 'script.plexodus/sign_in/digits/{0}.png'.format(pin[1].upper()))
        self.setProperty('pin.image.2', 'script.plexodus/sign_in/digits/{0}.png'.format(pin[2].upper()))
        self.setProperty('pin.image.3', 'script.plexodus/sign_in/digits/{0}.png'.format(pin[3].upper()))
