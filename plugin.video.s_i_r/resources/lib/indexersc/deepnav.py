...
class navigator:
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(40068, 'deepmovieGenres', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40069, 'deepmovieYears', 'ds.png', 'DefaultMovies.png')
        #self.addDirectoryItem(32013, 'deepmoviePersons', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40070, 'deepmovieLanguages', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40071, 'deepmovieCertificates', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40072, 'asmovies&url=trending', 'ds.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(40073, 'asmovies&url=popular', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40074, 'asmovies&url=views', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40075, 'asmovies&url=boxoffice', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40076, 'asmovies&url=oscars', 'ds.png', 'DefaultMovies.png')
        self.addDirectoryItem(40077, 'asmovies&url=theaters', 'ds.png', 'DefaultRecentlyAddedMovies.png')
        #self.addDirectoryItem(32005, 'movieWidget', 'ds.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(40068, 'deeptvGenres', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40078, 'deeptvNetworks', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40070, 'deeptvLanguages', 'lpng', 'DefaultTVShows.png')
        self.addDirectoryItem(40071, 'deeptvCertificates', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40069, 'deeptvYears', 'ds.png', 'ds.png')
        self.addDirectoryItem(40072, 'astvshows&url=trending', 'ds.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem(40073, 'astvshows&url=popular', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40079, 'astvshows&url=rating', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40074, 'astvshows&url=views', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40080, 'astvshows&url=airing', 'ds.png', 'DefaultTVShows.png')
        #self.addDirectoryItem(32025, 'astvshows&url=active', 'ds.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40081, 'astvshows&url=premiere', 'ds.png', 'DefaultTVShows.png')
