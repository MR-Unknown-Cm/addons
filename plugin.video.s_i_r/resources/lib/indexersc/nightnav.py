...
class navigator:
    def root(self):
        self.addDirectoryItem(32001, 'nightmaremovieNavigator', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(32002, 'nightmaretvNavigator', 'fre.png', 'DefaultTVShows.png')
    ...
    def movies(self, lite=False):
        self.addDirectoryItem(40068, 'nightmaremovieGenres', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40069, 'nightmaremovieYears', 'fre.png', 'DefaultMovies.png')
        #self.addDirectoryItem(32013, 'nightmaremoviePersons', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40070, 'nightmaremovieLanguages', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40071, 'nightmaremovieCertificates', 'fre.png', 'DefaultMovies.png')
        #self.addDirectoryItem(40072, 'nmaremov&url=trending', 'fre.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(40073, 'nmaremov&url=popular', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40074, 'nmaremov&url=views', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40075, 'nmaremov&url=boxoffice', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40076, 'nmaremov&url=oscars', 'fre.png', 'DefaultMovies.png')
        self.addDirectoryItem(40077, 'nmaremov&url=theaters', 'fre.png', 'DefaultRecentlyAddedMovies.png')
        #self.addDirectoryItem(32005, 'movieWidget', 'fre.png', 'DefaultRecentlyAddedMovies.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem(40068, 'nightmaretvGenres', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40078, 'nightmaretvNetworks', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40070, 'nightmaretvLanguages', 'lpng', 'DefaultTVShows.png')
        self.addDirectoryItem(40071, 'nightmaretvCertificates', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40069, 'nightmaretvYears', 'fre.png', 'fre.png')
        self.addDirectoryItem(40072, 'nmaretv&url=trending', 'fre.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem(40073, 'nmaretv&url=popular', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40079, 'nmaretv&url=rating', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40074, 'nmaretv&url=views', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40080, 'nmaretv&url=airing', 'fre.png', 'DefaultTVShows.png')
        #self.addDirectoryItem(32025, 'nmaretv&url=active', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(40081, 'nmaretv&url=premiere', 'fre.png', 'DefaultTVShows.png')
        self.addDirectoryItem(32006, 'calendar&url=added', 'fre.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
        self.addDirectoryItem(32027, 'calendars', 'fre.png', 'DefaultRecentlyAddedEpisodes.png')
