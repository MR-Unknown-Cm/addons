...
class Navigator:
    def root(self):
        ...
        self.addDirectoryItem('swift streams', 'swiftNavigator', 'tvshows.png', 'DefaultTVShows.png')
        ...
        if self.getMenuEnabled('navi.lists') is True:
           self.addDirectoryItem(32485, 'listNavigator', 'list.png', 'DefaultTVShows.png')
    ...
    def listnav(self):
        self.addDirectoryItem(32485, 'lists', 'list.png', 'DefaultTVShows.png')
    ...
    def movies(self, lite=False):
        ...
        if self.getMenuEnabled('navi.movie.tmdb.upcoming') is True:
            self.addDirectoryItem(32426 if control.setting('index.labels') == 'false' else 32427, 'tmdbmovies&url=tmdb_upcoming', 'movies.png' if control.setting('icon.logos') == 'Traditional' else 'tmdb.png', 'DefaultMovies.png')
