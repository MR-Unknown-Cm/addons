...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Still i Rise Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.s_i_r')
        os.makedirs(ad_folder)
    try:
        with open(versionFile, 'rb') as fh: oldVersion = fh.read()
    except: oldVersion = '0'
    try:
        curVersion = control.addon('plugin.video.s_i_r').getAddonInfo('version')
