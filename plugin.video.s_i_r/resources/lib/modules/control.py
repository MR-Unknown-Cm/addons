...
def artPath():
    theme = appearance()
    return os.path.join(xbmcaddon.Addon('plugin.video.s_i_r').getAddonInfo('path'), 'resources', 'artwork', theme)
#    if theme in ['-', '']: return
#    elif condVisibility('System.HasAddon(script.addonname.artwork)'):
#        return os.path.join(xbmcaddon.Addon('script.addonname.artwork').getAddonInfo('path'), 'resources', 'media', theme)
...
def artwork():
    if condVisibility('System.HasAddon(script.Still i Rise.artwork)'):
        execute('RunPlugin(plugin://script.Still i Rise.artwork)')
...
def metaFile():
    ...
    #    if condVisibility('System.HasAddon(script.addonname.metadata)'):
    #        return os.path.join(xbmcaddon.Addon('script.addonname.metadata').getAddonInfo('path'), 'resources', 'data', 'meta.db')
