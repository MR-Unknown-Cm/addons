...
class tvshows:
    def __init__(self):
        ...
        self.popular_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=100,&genres=crime&release_date=,date[0]&sort=year,asc&count=40&start=1'
        self.airing_link = 'http://www.imdb.com/search/title?title_type=tv_episode&release_date=date[1],date[0]&genres=crime&sort=year,asc&count=40&start=1'
        self.active_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&num_votes=10,&genres=crime&production_status=active&sort=year,asc&count=40&start=1'
        ...
        self.premiere_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&languages=en&num_votes=10,&release_date=date[60],date[0]&sort=release_date,desc&count=40&start=1'
        self.rating_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&num_votes=5000,&release_date=,date[0]&sort=user_rating,desc&count=40&start=1'
        self.views_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&num_votes=100,&release_date=,date[0]&sort=num_votes,desc&count=40&start=1'
        self.person_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&release_date=,date[0]&role=%s&sort=year,desc&count=40&start=1'
        self.genre_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=crime,%s&sort=moviemeter,asc&count=40&start=1&sort=alpha,asc'
        self.keyword_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&release_date=,date[0]&keywords=%s&sort=year,asc&count=40&start=1'
        self.language_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&num_votes=100,&production_status=released&primary_language=%s&sort=year,asc&count=40&start=1'
        ...
        self.year_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=crime&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
        ...
        self.certificationtvpg_link = 'https://www.imdb.com/search/title?title_type=tv_series,tv_miniseries&genres=crime&certificates=US%3ATV-PG'
        self.certificationtvpgt_link = 'https://www.imdb.com/search/title?title_type=tv_series,tv_miniseries&genres=crime&certificates=US%3ATV-14'
        self.certificationtvr_link = 'https://www.imdb.com/search/title?title_type=tv_series,tv_miniseries&genres=crime&certificates=US%3ATV-MA'
        self.certificationtvncseven_link = 'https://www.imdb.com/search/title?title_type=tv_series,tv_miniseries&genres=crime&certificates=US%3ANC-17&adult=include'
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1900, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'lf.png', 'action': 'tvshows'})
