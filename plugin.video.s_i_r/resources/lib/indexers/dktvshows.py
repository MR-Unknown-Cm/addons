...
class tvshows:
    def __init__(self):
        ...
        self.genre_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&release_date=,date[0]&genres=drama,romance,%s&sort=moviemeter,asc&count=40&start=1&sort=alpha,asc'
        ...
        self.year_link = 'http://www.imdb.com/search/title?title_type=tv_series,mini_series&genres=drama,romance&num_votes=100,&production_status=released&year=%s,%s&sort=moviemeter,asc&count=40&start=1'
