...
INFO_DIALOG_FILE_CLASSIC = u'%s-DialogVideoInfo-Netflix.xml' % (ADDON_ID)
LIST_DIALOG_FILE_CLASSIC = u'%s-VideoList-Netflix.xml' % (ADDON_ID)
ACTOR_DIALOG_FILE_CLASSIC = u'%s-DialogInfo-Netflix.xml' % (ADDON_ID)
