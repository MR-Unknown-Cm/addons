...
####################################################
    ...
    if params['opensettings'] == 'true':
        control.openSettings(query, "plugin.video.plexodus")
...
############################################################################################################
    ...
    if not docu_category == None:
        ...
        docu.documentary().root()
########################plex and plexodus####################################################################################
elif action == 'plexNavigator':
    from resources.lib.menus import navigator
    navigator.Navigator().plexn()


elif action == 'plexorg':
    from resources.lib.menus import navigator
    navigator.Navigator().plex()

elif action == 'plexodus':
    from resources.lib.menus import navigator
    navigator.Navigator().plexo()