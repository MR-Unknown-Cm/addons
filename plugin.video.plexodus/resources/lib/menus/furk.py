...
class Furk:
    ...
    def search(self):
        ...
        navigator.Navigator().addDirectoryItem('New Search', 'furkSearchNew', 'icon.png', 'icon.png')
        ...
        for (id,term) in dbcur.fetchall():
            if term not in str(lst):
                delete_option = True
                navigator.Navigator().addDirectoryItem(term, 'furkMetaSearch&url=%s' % term, 'icon.png', 'icon.png')
                lst += [(term)]
        dbcur.close()
